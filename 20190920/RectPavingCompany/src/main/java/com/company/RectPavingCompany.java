...
public class RectPavingCompany {
    ...
    public static void main(String[] args) {
        ...
        framingCost = Float.parseFloat(scan.nextLine());//should use a different variable, framingCost

        int area = length * width;
        int perimeter = 2*length + 2*width;//should be +, not -
        ...
        System.out.format("The cost of the framing/footers is %f.%n", perimeter*framingCost);//should be *
    }
}
