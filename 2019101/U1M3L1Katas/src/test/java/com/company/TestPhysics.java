...
public class TestPhysics {
    ...
    public void shouldCalculatePositiveForce(){
        assertEquals(12, physics.calculateForce(3.0, 4),delta);
    }
    @Test
    public void shouldCalculateNegativeForce(){
        assertEquals(-12, physics.calculateForce(3, -4.0),delta);
    }
    @Test
    public void shouldCalculateZeroForce(){
        assertEquals(0, physics.calculateForce(3.0, 0),delta);
    }
    @Test
    public void shouldCalculatePositiveVelocity(){
        assertEquals(3, physics.calculateVelocity(3,6.0,1,2),delta);
    }
    @Test
    public void shouldCalculateNegativeVelocity(){
        assertEquals(-3, physics.calculateVelocity(6,3.0,1,2),delta);
    }
    @Test
    public void shouldCalculateZeroVelocity(){
        assertEquals(0, physics.calculateVelocity(6.0,6,1,2),delta);
    }
    @Test
    public void shouldCalculatePositiveMass(){
        assertEquals(10, physics.calculateMass(100, 10.0),delta);
    }
    @Test
    public void shouldCalculateZeroMass(){
        assertEquals(0, physics.calculateMass(0.0, 10),delta);
    }
    @Test
    ...
    public void shouldCalculateZeroAcceleration(){
        assertEquals(0, physics.calculateAcceleration(2.0,2,1,2),delta);
    }
    @Test
    public void shouldReturnInfiniteAccelerationWhenDividingByZero(){
        assertEquals(Double.POSITIVE_INFINITY, physics.calculateAcceleration(1.0,2,1,1),delta);
    ...
    public void shouldReturnInfiniteVelocityWhenDividingByZero(){
        assertEquals(Double.POSITIVE_INFINITY, physics.calculateVelocity(1,2.0,1,1),delta);
        assertEquals(Double.NEGATIVE_INFINITY, physics.calculateVelocity(2,1,1,1),delta);
    }
    @Test
    public void shouldCalculatePositiveDistance(){
        assertEquals(12, physics.calculateDistance(3.0, 4),delta);
    }
    @Test
    public void shouldHandleZeroDistance(){
        assertEquals(0, physics.calculateDistance(0, 4.0),delta);
