...
public class Coffee {
    ...
    public Coffee(int coffee_id, int roaster_id, String name, int count, double unit_price, String description, String type) {
    ...
    public Coffee(int roaster_id, String name, int count, double unit_price, String description, String type) {
        this.roaster_id = roaster_id;
        this.name = name;
        this.count = count;
        this.unit_price = unit_price;
    ...
    public Coffee(int roaster_id, String name, int count, double unit_price, String type) {
        this.roaster_id = roaster_id;
        this.name = name;
        this.count = count;
        this.unit_price = unit_price;
